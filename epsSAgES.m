function [out,global_best, dyn]=epsSAgES(problem,input,CEC_fun_no)
    ...
    %
    % VARIATION: omit the transformation matrix adaptation
...
%        % Update transformation matrix
        M = M;  %M = (1 - 0.5*input.c1 - 0.5*input.cmu) * M + (0.5*input.c1)*(M*ps)*ps';       
%         for m = 1:mu
